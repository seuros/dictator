...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.23.0 to 0.24.0
    * dictator-freebsd bumped from 0.1.1 to 0.1.2
    * dictator-frontmatter bumped from 0.23.0 to 0.24.0
    * dictator-golang bumped from 0.23.0 to 0.24.0
    * dictator-python bumped from 0.23.0 to 0.24.0
    * dictator-ruby bumped from 0.23.0 to 0.24.0
    * dictator-rust bumped from 0.23.0 to 0.24.0
    * dictator-typescript bumped from 0.23.0 to 0.24.0

## [0.23.0](https://github.com/seuros/dictator/compare/dictator-v0.22.0...dictator-v0.23.0) (2026-09-17)
...
* the Dictator decrees scoped enforcement upon the uncommitted alone ([973c458](https://github.com/seuros/dictator/commit/973c45852f2e300aa10f179148cd0e326013274b))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * dictator-frontmatter bumped from 0.20.0 to 0.21.0
    * dictator-golang bumped from 0.20.0 to 0.21.0
    * dictator-decree-abi bumped from 0.20.0 to 0.21.0
    * dictator-python bumped from 0.20.0 to 0.21.0
    * dictator-ruby bumped from 0.20.0 to 0.21.0
    * dictator-rust bumped from 0.20.0 to 0.21.0
    * dictator-supreme bumped from 0.20.0 to 0.21.0
    * dictator-typescript bumped from 0.20.0 to 0.21.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * dictator-frontmatter bumped from 0.18.1 to 0.19.0
    * dictator-golang bumped from 0.18.1 to 0.19.0
    * dictator-decree-abi bumped from 0.18.1 to 0.19.0
    * dictator-python bumped from 0.18.1 to 0.19.0
    * dictator-ruby bumped from 0.18.1 to 0.19.0
    * dictator-rust bumped from 0.18.1 to 0.19.0
    * dictator-supreme bumped from 0.18.1 to 0.19.0
    * dictator-typescript bumped from 0.18.1 to 0.19.0
...
* migrate to mcp-host 0.1.30 ([cfecf96](https://github.com/seuros/dictator/commit/cfecf9614109afbe3637a71e65c740e68e6607a0))
...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.17.2 to 0.18.0
    * dictator-frontmatter bumped from 0.17.2 to 0.18.0
    * dictator-golang bumped from 0.17.2 to 0.18.0
    * dictator-decree-abi bumped from 0.17.2 to 0.18.0
    * dictator-python bumped from 0.17.2 to 0.18.0
    * dictator-ruby bumped from 0.17.2 to 0.18.0
    * dictator-rust bumped from 0.17.2 to 0.18.0
    * dictator-supreme bumped from 0.17.2 to 0.18.0
    * dictator-typescript bumped from 0.17.2 to 0.18.0
...
* resolve paths from client roots or CWD for stalint and dictator tools ([30710ff](https://github.com/seuros/dictator/commit/30710ffa38f6d1fba9d8c7014483bc7c71a0a478))
...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.17.0 to 0.17.1
    * dictator-frontmatter bumped from 0.17.0 to 0.17.1
    * dictator-golang bumped from 0.17.0 to 0.17.1
    * dictator-decree-abi bumped from 0.17.0 to 0.17.1
    * dictator-python bumped from 0.17.0 to 0.17.1
    * dictator-ruby bumped from 0.17.0 to 0.17.1
    * dictator-rust bumped from 0.17.0 to 0.17.1
    * dictator-supreme bumped from 0.17.0 to 0.17.1
    * dictator-typescript bumped from 0.17.0 to 0.17.1
...
* wasm caching ([#26](https://github.com/seuros/dictator/issues/26)) ([98b2812](https://github.com/seuros/dictator/commit/98b2812dab098888aa69befda60dd5219d499336))
...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.15.0 to 0.16.0
    * dictator-frontmatter bumped from 0.15.0 to 0.16.0
    * dictator-golang bumped from 0.15.0 to 0.16.0
    * dictator-decree-abi bumped from 0.15.0 to 0.16.0
    * dictator-python bumped from 0.15.0 to 0.16.0
    * dictator-ruby bumped from 0.15.0 to 0.16.0
    * dictator-rust bumped from 0.15.0 to 0.16.0
    * dictator-supreme bumped from 0.15.0 to 0.16.0
    * dictator-typescript bumped from 0.15.0 to 0.16.0
...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.13.0 to 0.14.0
    * dictator-frontmatter bumped from 0.13.0 to 0.14.0
    * dictator-golang bumped from 0.13.0 to 0.14.0
    * dictator-decree-abi bumped from 0.13.0 to 0.14.0
    * dictator-python bumped from 0.13.0 to 0.14.0
    * dictator-ruby bumped from 0.13.0 to 0.14.0
    * dictator-rust bumped from 0.13.0 to 0.14.0
    * dictator-supreme bumped from 0.13.0 to 0.14.0
    * dictator-typescript bumped from 0.13.0 to 0.14.0
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * dictator-frontmatter bumped from 0.10.1 to 0.11.0
    * dictator-golang bumped from 0.10.1 to 0.11.0
    * dictator-decree-abi bumped from 0.10.1 to 0.11.0
    * dictator-python bumped from 0.10.1 to 0.11.0
    * dictator-ruby bumped from 0.10.1 to 0.11.0
    * dictator-rust bumped from 0.10.1 to 0.11.0
    * dictator-supreme bumped from 0.10.1 to 0.11.0
    * dictator-typescript bumped from 0.10.1 to 0.11.0
...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.7.0 to 0.8.0
    * dictator-frontmatter bumped from 0.7.0 to 0.8.0
    * dictator-golang bumped from 0.7.0 to 0.8.0
    * dictator-decree-abi bumped from 0.7.0 to 0.8.0
    * dictator-python bumped from 0.7.0 to 0.8.0
    * dictator-ruby bumped from 0.7.0 to 0.8.0
    * dictator-rust bumped from 0.7.0 to 0.8.0
    * dictator-supreme bumped from 0.7.0 to 0.8.0
    * dictator-typescript bumped from 0.7.0 to 0.8.0

## [0.7.0](https://github.com/seuros/dictator/compare/dictator-v0.6.4...dictator-v0.7.0) (2025-12-12)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * dictator-frontmatter bumped from 0.6.4 to 0.7.0
    * dictator-golang bumped from 0.6.4 to 0.7.0
    * dictator-decree-abi bumped from 0.6.4 to 0.7.0
    * dictator-python bumped from 0.6.4 to 0.7.0
    * dictator-ruby bumped from 0.6.4 to 0.7.0
    * dictator-rust bumped from 0.6.4 to 0.7.0
    * dictator-supreme bumped from 0.6.4 to 0.7.0
    * dictator-typescript bumped from 0.6.4 to 0.7.0
...
* include sanitized snippets in MCP diagnostics ([a097870](https://github.com/seuros/dictator/commit/a0978703f095c671febd014ace48d6e1b67abf16))
...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.5.1 to 0.6.0
    * dictator-frontmatter bumped from 0.5.1 to 0.6.0
    * dictator-golang bumped from 0.5.1 to 0.6.0
    * dictator-decree-abi bumped from 0.5.1 to 0.6.0
    * dictator-python bumped from 0.5.1 to 0.6.0
    * dictator-ruby bumped from 0.5.1 to 0.6.0
    * dictator-rust bumped from 0.5.1 to 0.6.0
    * dictator-supreme bumped from 0.5.1 to 0.6.0
    * dictator-typescript bumped from 0.5.1 to 0.6.0
...
* honor gitignore boundaries to prevent territorial violations ([#2](https://github.com/seuros/dictator/issues/2)) ([0294614](https://github.com/seuros/dictator/commit/02946148fd25abad1a91890518ed05f15884f31b))
...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.3.0 to 0.4.0
    * dictator-frontmatter bumped from 0.3.0 to 0.4.0
    * dictator-golang bumped from 0.3.0 to 0.4.0
    * dictator-decree-abi bumped from 0.3.0 to 0.4.0
    * dictator-python bumped from 0.3.0 to 0.4.0
    * dictator-ruby bumped from 0.3.0 to 0.4.0
    * dictator-rust bumped from 0.3.0 to 0.4.0
    * dictator-supreme bumped from 0.3.0 to 0.4.0
    * dictator-typescript bumped from 0.3.0 to 0.4.0

## [0.3.0](https://github.com/seuros/dictator/compare/dictator-v0.2.0...dictator-v0.3.0) (2025-12-04)


### Features

* authorize occupy command for territorial config deployment ([#4](https://github.com/seuros/dictator/issues/4)) ([7a39e83](https://github.com/seuros/dictator/commit/7a39e83acdbc46bd81da40f4411f356a56a2f9cf)), closes [#3](https://github.com/seuros/dictator/issues/3)
...
* The following workspace dependencies were updated
  * dependencies
    * dictator-core bumped from 0.2.0 to 0.3.0
    * dictator-frontmatter bumped from 0.2.0 to 0.3.0
    * dictator-golang bumped from 0.2.0 to 0.3.0
    * dictator-decree-abi bumped from 0.2.0 to 0.3.0
    * dictator-python bumped from 0.2.0 to 0.3.0
    * dictator-ruby bumped from 0.2.0 to 0.3.0
    * dictator-rust bumped from 0.2.0 to 0.3.0
    * dictator-supreme bumped from 0.2.0 to 0.3.0
    * dictator-typescript bumped from 0.2.0 to 0.3.0

## [0.2.0](https://github.com/seuros/dictator/compare/dictator-v0.1.0...dictator-v0.2.0) (2025-12-04)


### Features

* initial implementation ([ebbb4f3](https://github.com/seuros/dictator/commit/ebbb4f30d293a2618fa6f5ba6547d363f2555304))


### Bug Fixes

* liberate CI with global -c config flag ([6681bac](https://github.com/seuros/dictator/commit/6681bac9ab32d65ee4a967a3bab4c2703f848ea8))
